...
export default function AccountSettings() {
  ...
  if (isLoading)
    return (
      <div className="text-xs py-10 flex gap-2">
  ...
  return (
    <div className="space-y-4">
      {success && (
        <Alert className="py-2 bg-emerald-500/10 text-emerald-600">
            ...
            <div>
              ...
              >
                {uploading ? (
                  ...
                  <IconUpload size={13} className="mr-1" />
                )}{" "}
                Change Avatar
              </Button>
            </div>
      ...
      <Card className="border-destructive/30 bg-destructive/5">
        <CardHeader className="py-3 px-4">
          <CardTitle className="text-sm text-destructive flex gap-2">
