  ...
  return (
    <div className="space-y-6">
      ...
      {noPeriod? (
        ...
        <>
          <div className="flex flex-wrap items-center justify-between gap-3"><div><h1 className="text-xl font-bold flex items-center gap-2"><IconGridDots className="text-sky-500" size={22}/> 10-Column Worksheet</h1><p className="text-sm text-muted-foreground mt-1">Trial Balance → Adjustments → Adjusted TB → Income Statement → Balance Sheet • IDR</p></div><Button asChild variant="outline" size="sm" className="gap-1.5"><Link href="/reports/income-statement"><IconTrendingUp size={14}/> Income Statement</Link></Button></div>
